    ...
    return (
      <div className="w-full max-w-md mx-auto mt-4">
        ...
        <div onDragOver={handleDragOver} onDrop={handleDrop} className={`${isEditMode ? "opacity-60" : ""} border-2 border-dashed rounded-lg p-4`}>
            <Input id="image-upload" type="file" className="hidden" ref={inputRef} onChange={handleImageFileChange} onDragOver={handleDragOver} onDrop={handleDrop} disabled={isEditMode}/>
            {!imageFile ? (
